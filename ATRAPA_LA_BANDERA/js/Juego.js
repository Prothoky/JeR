...
class Juego extends Phaser.Scene{
	...
	preloadImages(){
		...
		//Plataformas Nivel 0
		this.load.image("platN0_-1","../assets/img/Plataformas/Nivel0/izq.png");
		this.load.image("platN0_0","../assets/img/Plataformas/Nivel0/centro.png");
		this.load.image("platN0_1","../assets/img/Plataformas/Nivel0/dcha.png");
